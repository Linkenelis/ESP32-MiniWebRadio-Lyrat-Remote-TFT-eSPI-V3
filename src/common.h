...
#include <WiFiUdp.h>
    ...
    // Digital I/O used
        #define TFT_CS        15
        #define TFT_DC        33
        #define TFT_BL        22  // at -1 the brightness menu is not displayed
        #define TP_IRQ        36  // V
        #define TP_CS         32    //TMS    
        ...
        #define IR_PIN        -1
        #define TFT_MOSI      12  // TFT and TP (VSPI)  TDI
        #define TFT_MISO      14  // TFT and TP (VSPI)  TMS
        #define TFT_SCK       13  // TFT and TP (VSPI)  TCK
